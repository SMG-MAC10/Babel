...
public class GameManager
{
    ...
    public void PlaySound(string soundSource)
    {
        ...
        soundPlayer.PlaySound(GameObject.Find("Main Camera").GetComponent<AudioSource>(),
            Resources.Load<AudioClip>(soundSource));
    }

    public void PlayBGM(string soundSource)
    {
        ...
        soundPlayer.PlayMusic(GameObject.Find("Main Camera").AddComponent<AudioSource>(),
            Resources.Load<AudioClip>(soundSource));
    }
