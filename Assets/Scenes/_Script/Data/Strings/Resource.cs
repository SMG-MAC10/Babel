...
public class Resource
{
    ...
    public static readonly string MageIcon = "Field/Icon/iconMagician";
    ...
    public static readonly string LoadingBackgroundBattle = "Loading/loadingBattleBackground";
    public static readonly string ScrollOne = "Field/Inventory/scrollOne";
    public static readonly string ScrollThree = "Field/Inventory/scrollThree";
    public static readonly string ScrollFive = "Field/Inventory/scrollFive";
    public static readonly string ScrollChaos = "Field/Inventory/scrollChaos";
    public static readonly string ScrollDecompose = "Field/Inventory/scrollDecompose";
    public static readonly string ScrollSkill = "Field/Inventory/scrollSkill";
    public static readonly string ScrollEquip = "Field/Inventory/scrollEquip";
