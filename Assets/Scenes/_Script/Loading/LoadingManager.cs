...
public class LoadingManager : MonoBehaviour
{
    ...
    public static void LoadSceneEnding()
    {
        sceneName = "Ending";
        SceneManager.LoadScene("Loading");
    }

    public static void LoadSceneMainMenuInEnding()
    {
        sceneName = "Main";
    ...
    private void SetBackgroundBattle()
    {
        background.sprite = Resources.Load<Sprite>(Resource.LoadingBackgroundBattle);
    }
