...
public class LastBossActive1 : EnemyActiveSkills {
    ...
    public override void useSkill(List<BattleChar> target)
    {
        ...
        set.user.BM.sp.PlaySound(set.user.BM.audioSource, Resources.Load("Sound/Monster/main/boss/act1") as AudioClip);
...
public class LastBossActive2 : EnemyActiveSkills
{
    ...
    {
        base.useSkill(target);
        set.user.BM.sp.PlaySound(set.user.BM.audioSource, Resources.Load("Sound/Monster/main/boss/act2") as AudioClip);
        foreach (BattleChar bc in target)
        {
            bct = bc.getTarget();
            bct.setLastAttack(set.user);
...
public class LastBossActive3 : EnemyActiveSkills
{
    ...
    {
        base.useSkill(target);
        set.user.BM.sp.PlaySound(set.user.BM.audioSource, Resources.Load("Sound/Monster/main/boss/act3") as AudioClip);
        foreach (BattleChar bc in target)
        {
...
public class LastBossPas2Buff : Buff
{
    ...
    public override int updateTurn()
    {
        user.BM.sp.PlaySound(user.BM.audioSource, Resources.Load("Sound/Monster/main/boss/pas2") as AudioClip);
        if (enableBuff) {
            phyDam = 0.0f;
            mgcDam = 0.0f;
            enableBuff = false;
...
public class LastEnemyActive1 : EnemyActiveSkills {
    ...
    {
        base.useSkill(target);
        set.user.BM.sp.PlaySound(set.user.BM.audioSource, Resources.Load("Sound/Monster/main/sub1/act1") as AudioClip);
        foreach (BattleChar bc in target)
        {
...
public class LastEnemyActive2 : EnemyActiveSkills
{
    ...
    {
        base.useSkill(target);
        set.user.BM.sp.PlaySound(set.user.BM.audioSource, Resources.Load("Sound/Monster/main/sub1/act2") as AudioClip);
        total = 0;
...
public class LastEnemyActive3 : EnemyActiveSkills
{
    ...
    {
        base.useSkill(target);
        set.user.BM.sp.PlaySound(set.user.BM.audioSource, Resources.Load("Sound/Monster/main/sub2/act1") as AudioClip);
        foreach (BattleChar bc in target)
        {
...
public class LastEnemyAct3Buff : Buff {
    ...
    public override int updateTurn()
    {
        ...
        if (tmp == 0)
        {
            user.BM.sp.PlaySound(user.BM.audioSource, Resources.Load("Sound/Monster/main/sub2/act1_active") as AudioClip);
...
public class LastEnemyAct4Buff : Buff{
    ...
    public override void endTurn()
    {
        ...
        {
            user.BM.sp.PlaySound(user.BM.audioSource, Resources.Load("Sound/Monster/main/sub2/pas2") as AudioClip);
            //target.BM.curState = BattleManager.BattleState.ANIM;
            target.stigma++;
            user.animator.SetBool(key, true);
            user.StartCoroutine(user.IsAnimEnd(key));
        }
    }
}
