...
public class MidBossActive1 : MidEnemyActives
{
    ...
    public override void useSkill(List<BattleChar> target)
    {
        ...
        set.user.BM.sp.PlaySound(set.user.BM.audioSource, Resources.Load("Sound/Monster/mid/boss/" + key) as AudioClip);
        int xpos=-1, ypos=-1;
...
public class MidBossActive2 : MidEnemyActives
{
    ...
    public override void useSkill(List<BattleChar> target)
    {
        ...
        base.useSkill(target);
        set.user.BM.sp.PlaySound(set.user.BM.audioSource, Resources.Load("Sound/Monster/mid/boss/" + key) as AudioClip);
        foreach (BattleChar bc in this.target)
        {
            bct = bc.getTarget();
            bct.setLastAttack(set.user);
...
public class MidBossPas3Buff : Buff
{
    ...
    {
        stigma = user.stigma;
        user.BM.sp.PlaySound(user.BM.audioSource, Resources.Load("Sound/Monster/mid/boss/pas3") as AudioClip);
...
public class MidEnemyActive1 : EnemyActiveSkills {
    ...
    {
        base.useSkill(target);
        set.user.BM.sp.PlaySound(set.user.BM.audioSource, Resources.Load("Sound/Monster/mid/sub1/act1") as AudioClip);
...
public class MidEnemyActive2 : EnemyActiveSkills
{
    ...
    {
        base.useSkill(target);
        set.user.BM.sp.PlaySound(set.user.BM.audioSource, Resources.Load("Sound/Monster/mid/sub1/act2") as AudioClip);
...
public class MidEnemyActive3 : EnemyActiveSkills
{
    ...
    {
        base.useSkill(target);
        set.user.BM.sp.PlaySound(set.user.BM.audioSource, Resources.Load("Sound/Monster/mid/sub2/act1") as AudioClip);
...
public class MidEnemyPas1Buff : Buff{
    ...
    {
        user.BM.sp.PlaySound(user.BM.audioSource, Resources.Load("Sound/Monster/mid/sub2/pas1") as AudioClip);
